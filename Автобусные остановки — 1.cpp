// Автобусные остановки — 1.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//
...
//void ALL_BUSES( map<string, vector<string>> m)
//{
//	for ( auto p : m) {
